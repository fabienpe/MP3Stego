...
# PROP Scc_ProjName ""$/MP3Stego Decoder", TBAAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D BS_FORMAT=BINARY /FR /YX /FD /c
...
SOURCE="$(InputPath)"
PostBuild_Cmds=copy    Release\decode.exe    ..\ 
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D BS_FORMAT=BINARY /FR /YX /FD /c
